...
const Address = () => {
                ...
                <div className="row header">
                    ...
                    <div className="col-8">
                        <div className="menu-logo">
                            {/* <img alt="menu" src="https://electriceranet.store/img/small-logo.png" height="30px"> */}
                            <h4 className="mb-0 mt-1 ms-2">Add delivery address</h4>
                        </div>
                    </div>
                    {/* <div class="col-1">
      <div class="menu-icon">
          <svg width="16" height="16" viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg"><g fill="#000" fill-rule="evenodd"><path d="m11.618 9.897l4.225 4.212c.092.092.101.232.02.313l-1.465 1.46c-.081.081-.221.072-.314-.02l-4.216-4.203"/><path d="m6.486 10.901c-2.42 0-4.381-1.956-4.381-4.368 0-2.413 1.961-4.369 4.381-4.369 2.42 0 4.381 1.956 4.381 4.369 0 2.413-1.961 4.368-4.381 4.368m0-10.835c-3.582 0-6.486 2.895-6.486 6.467 0 3.572 2.904 6.467 6.486 6.467 3.582 0 6.486-2.895 6.486-6.467 0-3.572-2.904-6.467-6.486-6.467"/></g></svg>            </div>
  </div>
  <div class="col-1">
      <div class="menu-icon">
  ...
  <path d="m13.424 13.325c0 .837-.664 1.516-1.484 1.516-.82 0-1.484-.679-1.484-1.516 0-.837.664-1.516 1.484-1.516.82 0 1.484.679 1.484 1.516"></path>
        ...
        <div className="flex w-full justify-center">
          <h4 className="text-black text-xl">Add Delivery Address</h4>
        </div>
      </div> */}
            <div className="_1fhgRH mb-70">
                <div className="card py-1 max-height">
                    ...
                    >
                        ...
                        >
                            ...
                            />
                            <path
                                d="M60.9941 22H59.5762V15.1504L57.4844 15.8652V14.6641L60.8125 13.4395H60.9941V22Z"
                                fill="white"
                            />
                            <path
                            ...
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M78 17.5H162V18.5H78V17.5Z"
                                fill="#DBDBDB"
                            />
                            <path
                                fillRule="evenodd"
                                clipRule="evenodd"
                                d="M198 17.5H282V18.5H198V17.5Z"
                                fill="#DBDBDB"
                            />
                        </svg>
                    </div>
                        ...
                        <div className="card-body">
                            <div className="form-floating mb-3">
                                <input
                                    ...
                                    required
                                />
                                <label htmlFor="floatingInput">Full Name (Required)*</label>
                            </div>
                            <div className="form-floating mb-3">
                                <input
                                    className="form-control"
                                    ...
                                    required
                                />
                                <label htmlFor="floatingInput">Mobile number (Required)*</label>
                            </div>
                            <div className="form-floating mb-3">
                                <input
                                    className="form-control"
                                    ...
                                    required
                                />
                                <label htmlFor="floatingInput">Pincode (Required)*</label>
                            </div>
                            <div className="row">
                                <div className="col-6 form-floating">
                                    <input
                                        ...
                                        required
                                    />
                                    <label htmlFor="floatingInput">City (Required)*</label>
                                </div>
                                <div className="col-6 form-floating">
                                    <select
                                    ...
                                    <label htmlFor="floatingInput">State (Required)*</label>
                                </div>
                            </div>
                            <div className="form-floating mb-3">
                                <input
                            ...
                            <div
                                className="card-footer  bottom-btn px-0"
                                style={{
                                    width: "96%",
                                    margin: "auto",
                                }}
